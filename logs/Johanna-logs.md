...
* 2h working on case in Fusion: finalize case design (added slits for air flow, fix dimensions) and print at Lichtwerkstatt (unfortunately there was a bug in the first layer of the case, so the print did not work)
