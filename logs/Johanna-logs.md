## Week 1
* 20 min organisation of meeting, contacting supervisors, setting up Trello group, writing down tasks (see screenshots [1](logs/Trello1.PNG) and [2](logs/Trello2.PNG))
...
* 60 min reading papers more in detail, writing down some important information (see [PDF](logs/notes_26_04.pdf))
